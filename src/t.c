...
static B jtpdef(J jt, C id, I t, AF f1, AF f2, I m, I l, I r)
{
	A z;
	V*v;
	GA(z, t, 1, 0, 0);
...
B jtpinit(J jt)
{
	...
	/*  a. */  pst[(UC)CALP ] = t = alp;
	ACX(t);
	/*  a: */  pst[(UC)CACE ] = t = ace = sc4(BOX, (I)mtv);
	ACX(t);
	/*  (  */  pst[(UC)CLPAR] = t = sc4(LPAR, 0L);
	ACX(t);
	/*  )  */  pst[(UC)CRPAR] = t = sc4(RPAR, 0L);
	ACX(t);
	/*  =. */  GA(t, ASGN, 1, 0, 0);
	ACX(t);
	*CAV(t) = CASGN;
